...
class QBlock(QGraphicsItem):
    ...
    def __init__(self, block, parent = None):
        ...
        self.width = 40
        self.inEllipses = [] # in ports endings
        self.outEllipses = []# out ports endings
        ...
        #     self.inEllipses.append(QGraphicsEllipseItem(-QBlock.PORT_SIZE,di*(i + 1),0,di*(i + 1), 3)
        #     self.inEllipses[-1].setCursor(Qt.WhatsThisCursor)
        #
        # for i in range(len(self.block.output_ports)):
        #     self.outEllipses.append(QGraphicsEllipseItem(self.width+ QBlock.PORT_SIZE,do*(i + 1)), 3)
        #     self.outEllipses[-1].setCursor(Qt.WhatsThisCursor)
